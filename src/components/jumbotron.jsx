        ...
        <div class="row">
            <div class="col-md-12">
                <div class="jumbotron">
                    ...
                    <hr class="my-4"></hr>
                    <a class="btn btn-primary btn-lg" href="#" role="button">Mi Vacuna</a>
                    <button class="btn btn-primary btn-lg" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Terminos y condiciones</button>
